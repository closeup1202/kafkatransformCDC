...
public final class ChangedDataSchema {

    private ChangedDataSchema(){

    }

    static Schema getSchema(List<Integer> integers, List<Field> dataList) {
    ...
    static Schema parentSchema(Schema schema, Struct childValue) {
    ...
    static Struct parentValue(Struct value, Struct childValue, Schema parentSchema) {
